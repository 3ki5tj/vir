...
\title{Thermodynamic integrals in integral equations}
...
We first review basic formulas of integral equations.
%
The virial expansion is a series expansion of
...
%
The first equation is the exact
  Ornstein-Zernike (OZ) relation\cite{hansen},
%
\begin{align}
  t(\vr) &= \rho [c * (c + t)](\vr), \notag \\
...
Below we shall express thermodynamic quantities
  as integral of $c(\vr)$ and $t(\vr)$
  in integral equations by a graphic analysis,
%
and the virial coefficients in \eqref{eq:virial}
  can be found from these expression.
%
