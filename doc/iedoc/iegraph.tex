...
\end{equation}
The relation is also true for the exact graphic sum of $y(\vr)$,
...
\subsection{\label{sec:hncFex}Graphic sums of the Helmholtz free energy and chemical potential}
