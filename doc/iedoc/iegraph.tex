...
Since \eqref{eq:crcompr} and \eqref{eq:baxterpressure}
differ only by a differentiation with respect to the density, $\rho$,
they must produce the same virial coefficients.
