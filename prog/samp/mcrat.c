...
INLINE void movesys(int *sys, int fb, int nz, int ifb,
...
#define REPORT_LOOKUP() { \
      ...
      fprintf(stderr, "D %d, n %d, t%11g, cacc %.4f/%.4f/%.4f, " \
        ...
        (int) gmapid, fbnz/hist[0], hist[1]/hist[0], hist[2]/hist[1], \
