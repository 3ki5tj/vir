...
dgref_t dgref5[] = {
  {0, {{0, 0}}, -6, 12, 0},
  {-1, {{0, 1}}, 0, 6, 1},
  {-2, {{0, 1}, {2, 3}}, 3, 4, 0}, /* a~b c~d */
  {-2, {{0, 1}, {1, 3}}, 0, 2, 1}, /* a~b~c */
  {-2, {{0, 4}, {2, 4}}, 0, 2, 1}, /* a~b~c */
  {-3, {{0, 1}, {2, 3}, {3, 4}}, 2, 2, 0}, /* a~b~c d~e */
  {-3, {{0, 1}, {1, 3}, {2, 4}}, 2, 2, 0}, /* a~b~c d~e */
  {-4, {{0, 1}, {1, 2}, {2, 3}, {3, 0}}, 0, 1, 1}, /* 4-ring */
  {6, {{0, 2}, {2, 3}, {3, 1}, {1, 4}, {4, 0}, {0, 3}}, 0, 1, 1},
  {6, {{0, 1}, {1, 3}, {3, 4}, {4, 0}, {1, 2}, {2, 4}}, 1, 0, 0},
  {5, {{0, 1}, {1, 2}, {2, 3}, {3, 4}, {4, 0}}, -1, 1, 0},
  {DGREF_NPRMAX, {{0, 0}}, 0, 0, 0},
};
...
dgref_t dgref6[] = {
  {0, {{0, 0}}, -24, 60, 0},
  {-1, {{0, 1}}, 0, 36, 1}, /* a~b */
  {-2, {{0, 1}, {2, 3}}, 12, 24, 0}, /* a~b c~d */
  {-2, {{0, 4}, {2, 4}}, 0, 18, 1}, /* a~b~c */
  {-3, {{0, 1}, {2, 3}, {4, 5}}, 16, 16, 0}, /* a~b c~d e~f */
  {-3, {{0, 1}, {2, 3}, {3, 4}}, 8, 14, 0}, /* a~b~c d~e */
  {-3, {{0, 1}, {1, 2}, {0, 2}}, 0, 6, 1}, /* 3-clique */
  {-4, {{0, 1}, {1, 2}, {0, 2}, {3, 4}}, 4, 6, 0}, /* 3-clique a~b */
  {-4, {{0, 1}, {1, 2}, {2, 3}, {4, 5}}, 5, 8, 0}, /* a~b~c~d e~f */
  {-4, {{0, 1}, {1, 2}, {2, 3}, {3, 1}}, 0, 2, 1}, /* 4-ring */
  {-5, {{0, 1}, {1, 2}, {0, 2}, {3, 4}, {3, 5}}, 0, 6, 0}, /* 3-clique a~b~c */
  {-5, {{0, 1}, {1, 2}, {2, 3}, {3, 4}, {4, 0}}, -4, 5, 0}, /* 5-ring */
  {-6, {{0, 1}, {0, 2}, {0, 3}, {1, 2}, {1, 3}, {2, 3}}, 0, 0, 1}, /* 4-clique */
  {-6, {{0, 1}, {0, 2}, {1, 2}, {3, 4}, {4, 5}, {5, 3}}, -4, 6, 0}, /* two 3-rings */
  {-7, {{0, 1}, {1, 2}, {2, 3}, {3, 4}, {4, 5}, {2, 5}, {3, 5}}, 0, 0, 1},
  {7, {{4, 2}, {2, 3}, {3, 5}, {5, 1}, {1, 0}, {0, 4}, {1, 3}}, 0, 1, 1},
  {7, {{4, 3}, {3, 5}, {5, 1}, {1, 2}, {2, 4}, {0, 3}, {0, 1}}, -1, 0, 0},
  {6, {{4, 5}, {5, 1}, {1, 3}, {3, 2}, {2, 0}, {0, 4}}, 1, 1, 0},
  {DGREF_NPRMAX, {{0, 0}}, 0, 0, 0},
};
...
dgref_t dgref7[] = {
  {0, {{0, 0}}, -120, 360, 0},
  {-1, {{0, 1}}, 0, 240, 1}, /* a~b */
  {-2, {{0, 1}, {2, 3}}, 60, 168, 0}, /* a~b c~d */
  {-2, {{4, 5}, {5, 6}}, 0, 144, 1}, /* a~b~c */
  {-3, {{0, 1}, {1, 2}, {3, 4}}, 40, 108, 0}, /* a~b~c d~e */
  {-3, {{0, 1}, {2, 3}, {4, 5}}, 80, 120, 0}, /* a~b c~d e~f */
  {-3, {{0, 1}, {1, 2}, {0, 2}}, 0, 72, 1}, /* 3-clique of e-bonds */
  {-4, {{0, 1}, {1, 2}, {2, 3}, {4, 5}}, 25, 70, 0}, /* a~b~c~d e~f */
  {-5, {{6, 1}, {1, 2}, {2, 3}, {3, 4}, {0, 5}}, 14, 48, 0}, /* a~b~c~d~e f~g */
  {-6, {{0, 1}, {0, 2}, {0, 3}, {1, 2}, {1, 3}, {2, 3}}, 0, 0, 1}, /* 3-clique */
  {-6, {{0, 1}, {0, 2}, {1, 2}, {3, 4}, {4, 5}, {5, 3}}, -20, 36, 0}, /* two 3-rings */
  {-7, {{0, 1}, {1, 2}, {2, 3}, {3, 4}, {4, 5}, {2, 5}, {3, 5}}, 0, 8, 1},
  {-8, {{0, 1}, {1, 2}, {2, 3}, {3, 4}, {4, 5}, {2, 5}, {3, 5}, {2, 4}}, 0, 0, 1},
  {8, {{4, 5}, {5, 3}, {3, 1}, {1, 2}, {2, 6}, {2, 0}, {0, 4}, {4, 6}}, 1, 0, 0},
  {8, {{4, 5}, {5, 3}, {3, 1}, {1, 2}, {2, 6}, {6, 0}, {0, 4}, {4, 6}}, 0, 1, 1},
  {8, {{4, 5}, {5, 3}, {3, 1}, {1, 2}, {2, 6}, {6, 0}, {0, 4}, {2, 0}}, 0, 1, 1},
  {7, {{4, 2}, {2, 3}, {3, 5}, {5, 1}, {1, 6}, {6, 0}, {0, 4}}, -1, 1, 0},
  {DGREF_NPRMAX, {{0, 0}}, 0, 0, 0},
};
...
dgref_t dgref8[] = {
  {0, {{0, 0}}, -720, 2520, 0},
  {-1, {{0, 1}}, 0, 1800, 1}, /* a~b */
  {-2, {{5, 6}, {4, 7}}, 360, 1320, 0}, /* a~b b~c */
  {-2, {{4, 5}, {5, 6}}, 0, 1200, 1}, /* a~b~c */
  {-3, {{0, 1}, {1, 2}, {4, 5}}, 240, 912, 0}, /* a~b~c d~e */
  {-3, {{0, 1}, {2, 3}, {4, 5}}, 480, 984, 0}, /* a~b c~d e~f */
  {-4, {{0, 1}, {2, 3}, {4, 5}, {6, 7}}, 450, 744, 0}, /* a~b c~d e~f g~h */
  {-4, {{0, 1}, {1, 2}, {2, 3}, {4, 5}}, 150, 636, 0}, /* a~b~c~d e~f */
  {-5, {{6, 1}, {1, 2}, {2, 3}, {4, 5}, {0, 7}}, 168, 496, 0}, /* a~b~c~d e~f g~h */
  {-5, {{6, 1}, {1, 2}, {2, 3}, {3, 4}, {0, 7}}, 84, 458, 0}, /* a~b~c~d~e f~g */
  {-6, {{0, 1}, {1, 2}, {2, 3}, {3, 4}, {4, 5}, {6, 7}}, 13, 340, 0}, /* a~b~c~d~e~f g~h */
  {9, {{5, 2}, {2, 4}, {4, 3}, {3, 1}, {1, 6}, {6, 0}, {0, 7}, {0, 5}, {2, 7}}, -1, 0, 0},
  {9, {{5, 2}, {2, 4}, {4, 3}, {3, 1}, {1, 6}, {6, 0}, {0, 7}, {7, 5}, {1, 7}}, 0, 1, 1},
  {9, {{5, 2}, {2, 4}, {4, 3}, {3, 1}, {1, 6}, {6, 0}, {0, 7}, {7, 5}, {3, 6}}, 0, 1, 1},
  {8, {{7, 2}, {2, 3}, {3, 5}, {5, 1}, {1, 6}, {6, 0}, {0, 4}, {4, 7}}, 1, 1, 0},
  {DGREF_NPRMAX, {{0, 0}}, 0, 0, 0},
};
...
dgref_t dgref9[] = {
  {0, {{0, 0}}, -5040, 20160, 0},
  {-1, {{3, 8}}, 0, 15120, 1}, /* a~b */
  {-2, {{5, 6}, {4, 7}}, 2520, 11520, 0}, /* a~b c~d */
  {-2, {{4, 5}, {5, 6}}, 0, 10800, 1}, /* a~b~c */
  {-3, {{0, 1}, {1, 2}, {4, 5}}, 1680, 8400, 0}, /* a~b~c d~e */
  {-3, {{0, 1}, {2, 3}, {4, 5}}, 3360, 8880, 0}, /* a~b c~d e~f */
  {-4, {{4, 5}, {5, 6}, {1, 2}, {7, 8}}, 2100, 6576, 0}, /* a~b~c d~e f~g */
  {-4, {{0, 1}, {2, 3}, {4, 5}, {6, 7}}, 3150, 6912, 0}, /* a~b c~d e~f g~h */
  {-4, {{0, 1}, {1, 2}, {2, 3}, {4, 5}}, 1050, 6168, 0}, /* a~b~c~d e~f */
  {-5, {{6, 1}, {1, 2}, {2, 3}, {4, 5}, {0, 7}}, 1176, 4896, 0}, /* a~b~c~d e~f g~h */
  {-5, {{6, 1}, {1, 2}, {2, 3}, {3, 4}, {0, 7}}, 588, 4620, 0}, /* a~b~c~d~e f~g */
  {-6, {{6, 1}, {1, 2}, {2, 3}, {3, 4}, {0, 7}, {5, 8}}, 518, 3704, 0}, /* a~b~c~d~e f~g h~i */
  {-6, {{0, 1}, {1, 2}, {2, 3}, {3, 4}, {4, 5}, {6, 7}}, 91, 3526, 0}, /* a~b~c~d~e~f g~h */
  {DGREF_NPRMAX, {{0, 0}}, 0, 0, 0},
};
